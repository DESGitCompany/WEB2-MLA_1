...
//elem.innerHTML += "Demo <select><option>Empty</option></select> <button class='btn' id='save'>Save</button><button class='btn' id='load'>Load</button><button class='btn' id='download'>Export</button><button class='btn' id='Import'>Import</button>";
elem.innerHTML += "<button class='btn' id='save'>Save</button><button class='btn' id='load'>Load</button><button class='btn' id='download'>Export</button><input type='file' id='fileInput' style='display: none;'><button class='btn' id='import'>Import</button>";
...
elem.querySelector("#import").addEventListener("click", () => {
...
elem.querySelector("#fileInput").addEventListener("change", function (event) {
	...
	if (file) {
		...
		reader.onload = function (e) {
			...
			//console.log('File has been imported:', importedData);
			console.log('File has been imported');
			if(importedData)
				graph.configure(importedData);
		};
